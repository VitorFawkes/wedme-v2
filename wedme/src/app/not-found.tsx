...
export default function NotFound() {
  return (
    <main className="min-h-dvh flex flex-col items-center justify-center bg-background px-6 md:px-12 text-center safe-px safe-top safe-bottom">
      ...
      <Link
        href="/"
        className="inline-flex items-center justify-center min-h-12 px-7 mt-10 rounded-md bg-primary text-primary-foreground text-sm font-medium tracking-wide hover:bg-brand-wine transition-colors"
      >
        Voltar ao início
      </Link>
    </main>
